<template>
<el-dialog title="人员选择" :visible.sync="showFlag" @close="closeDialog" :close-on-click-modal="false" v-drag class="drag-small" >
    <el-form ref="form" label-width="80px" :model="tempAll" class="formStyle hundred-percent-input">
        <el-row>
            <el-col :span="6">
                <el-form-item label="用户名称" prop="userName">
                    <el-input size="mini"  placeholder="请输入" v-model="tempAll.userName" @keyup.enter.native="getList"></el-input>
                </el-form-item>
            </el-col>
            <el-col :span="6">
                <el-form-item label="用户代码：" prop="userCode">
                    <el-input size="mini"  placeholder="请输入" v-model="tempAll.userCode" @keyup.enter.native="getList"></el-input>
                </el-form-item>
            </el-col>
    ...
    <el-table :data="gridData" border stripe fit highlight-current-row height="300" @row-click="handleRowClick"  @row-dblclick="handleRowDblclick" style="width: 100%" v-loading.body="listLoading">
        <el-table-column prop="userName" label="用户名称" header-align="center" show-overflow-tooltip></el-table-column>
        <el-table-column prop="userCode" label="用户代码" header-align="center" show-overflow-tooltip></el-table-column>
    </el-table>
    <el-pagination
...
export default {
    ...
    methods:{
        ...
        resetBtn(){
            this.tempAll.userCode = '' ;
            this.tempAll.userName = '' ;
            this.listQuery = {
                pageSize:10,
                currentPage:1
            }
