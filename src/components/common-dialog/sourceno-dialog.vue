<template>
  <el-dialog title="采购暂收单选择" :visible.sync="showFlag" @close="closeDialog" :close-on-click-modal="false" v-drag class="drag-small">
    <el-form ref="form" label-width="110px" :model="tempAll" class="formStyle hundred-percent-input">
      <el-row>
        ...
        <!-- bizOrgName supplierName manageSubName -->
        <el-col :span="6">
    ...
    <el-table :data="gridData" border stripe fit highlight-current-row height="300" @row-click="handleRowClick" @row-dblclick="handleRowDblclick" style="width: 100%" v-loading.body="listLoading">
      <el-table-column align="center" prop="poGrNo" label="暂收单号" width="200px" header-align="center" show-overflow-tooltip></el-table-column>
      <el-table-column align="center" prop="bizOrgName" label="部门" header-align="center" show-overflow-tooltip></el-table-column>
      <el-table-column align="center" prop="supplierName" label="供应商" width="200px" header-align="center" show-overflow-tooltip></el-table-column>
      <el-table-column align="center" prop="manageSubName" label="经营主体" width="200px" header-align="center" show-overflow-tooltip></el-table-column>
    </el-table>
