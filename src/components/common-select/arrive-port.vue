<template>
  <div>
    ...
    <div class="searchDialogOpen" @click="showMainInfoDialog">
      <i class="el-icon-search"></i>
    </div>
    <arrive-port :supplierShow="supplierShow" @rowDblclick="rowDblclic" @closeSupplier="closeSupplier"></arrive-port>
  </div>
</template>
<script>

  import arrivePort from 'components/common-dialog/arrive-port.vue';
...
//          debugger;
      ...
      console.log(this.tempAll.supplyName,"selectName")
    },
    methods: {
      //测试
      rowDblclic(val){
