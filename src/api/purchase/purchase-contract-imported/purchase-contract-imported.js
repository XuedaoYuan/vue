/*
* @Author: Marte
* @Date:   2017-12-04 17:32:57
* @Last Modified by:   Marte
* @Last Modified time: 2017-12-12 18:34:58
*/
...
export function doQueryCodPoWithPage(query,form) {
    ...
    let data = {
        ...
        "data": {
            ...
            'currencyName':form.currencyName,//币别
            'currencyCode':form.currencyCode,//币别
            'currencyId':form.currencyId,//币别
            // 'signDate':form.signDate,//签署日期--开始
            ...
            "tradeZoneName":form.tradeZoneName,//贸易国别
            "tradeZoneCode":form.tradeZoneCode,//贸易国别
            // "tradeZoneId":form.tradeZoneId,//贸易国别
            "portName":form.portName,//目的港
