              ...
              <el-row :gutter="6">
                ...
                <el-col :span="6">
                  <el-form-item label="发票类别" prop="poInvoiceType">
                    <el-select  v-model="formData.poInvoiceType" placeholder="请选择" size="mini" clearable :disabled="editStatus" collapse-tags>
              ...
              <el-row :gutter="6">
                ...
                <el-col :span="6">
                  <el-form-item label="凭证日期" prop="certificatesDate">
                    <el-date-picker type="date" placeholder="选择日期" :editable="false" v-model="certificatesDate"
              ...
              <el-row :gutter="6">
                ...
                <el-col :span="6">
                  <el-form-item label="发票日期" prop="invoiceDate">
                    <el-date-picker type="date" placeholder="选择日期" v-model="invoiceDate"
                                    size="mini" ></el-date-picker>
                  </el-form-item>
                </el-col>
                <el-col :span="6">
...
<script type="text/javascript">
  ...
  import {doAddCodPoInvoice,createPrompt } from '../../../api/purchase/purchase-invoice/purchase-invoice.js';
...
//      createdBtnStatus(){ //创建按钮
//          if(this.formData.manageSubId && this.formData.poInvoiceType && this.formData.bizOrgId && this.formData.currencyId &&this.formData.supplierId){
//            return false;
//          }
//          return true;
//      },
      ...
      calcuteAmtMoney(row){ //输入金额
        setTimeout(()=> {
          if(row.orginInvoiceAmtTex){
            var obj = amtTexBlur({"amtTex":row.orginInvoiceAmtTex,"num":row.currentInvoiceQty,"texRate":row.texRate});
            row.orginTexAmt = obj.texAmt;//原币税额
            row.orginInvoiceAmt = obj.amt;//原币税前金额
