<template>
  <div class="allTemplate creditAdd" >
    <div class="info">
      <el-button type="primary" icon="el-icon-search" size="mini" @click="submitForm">保 存</el-button>
...
<script type="text/javascript">
  import {doCusSave} from 'api/basic-data/port/port.js';
      ...
      onClick() {
       ...
       submitForm() {
         this.$confirm('您确认要新增吗?', '提示', {
           ...
           doCusSave(this.formData).then(response => {
