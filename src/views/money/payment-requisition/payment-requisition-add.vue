			...
			<div v-show="searchBarFlg">
				<el-tabs v-model="activeName" @tab-click="handleClick">
					<el-tab-pane label="抬头数据" name="first">
						...
						style="height: 190px;" :rules="rules">
						<el-row>
							<el-col :span="6">
		...
		<el-row :gutter="20">
			<el-col :span="8">
				<el-form-item label="创建人" prop="createdBy">
					<el-col :span="18">
						<el-input v-model="formData2.createdBy" size="mini" :disabled="true"></el-input></el-col>
					</el-form-item>
				</el-col>
				<el-col :span="8">
					...
					<el-row :gutter="20" style="margin-bottom:12px">
						<el-col :span="8">
							<el-form-item label="创建时间" prop="createdTime">
								<el-col :span="18">
									<el-input v-model="formData2.createdTime" size="mini" :disabled="true"></el-input></el-col>
								</el-form-item>
							</el-col>
							<el-col :span="8">
								<el-form-item label="修改时间" prop="name">
									<el-col :span="18">
										<el-input v-model="formData2.name" size="mini" :disabled="true"></el-input></el-col>
									</el-form-item>
								</el-col>
								<el-col :span="8">
            ...
            deleteClick() {
            	if (this.selectchange2.length < 1) {
            		...
            		this.selectchange2.forEach((x, i) => {
            			var idx = this.tableData2.findIndex((val) => val.id == x.id);
            			console.log(idx)
                            ...
                            success: (valid) => { //成功回掉
                                ...
                                //校验通过后，代码书写处
                                    this.$confirm('您确认要新增吗?', '提示', {
                                        ...
                                        doCreatePayApply(vm.formData, vm.tableData1).then(res => {
